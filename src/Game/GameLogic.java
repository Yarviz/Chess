...
public class GameLogic extends Board {
    ...
    protected int lookPlayerDraw(BoardTable[][] table, LogicRules rules) {

        if (rules.check && !rules.checkmate && rules.escape_moves.isEmpty()) return 0;
            else if (rules.check) return 0;
